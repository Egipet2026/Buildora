    ...
    <>
      ...
      >
        <form action={action} className="space-y-4">
          ...
          <p className="text-[0.75rem] leading-relaxed text-[var(--color-ink-3)]">
            Conversations stay on BizHub. Your email address is never shared
  ...
  return (
    <>
      ...
      <Dialog
        ...
        description="Reports are reviewed by the BizHub team. The person you report is not told who reported them."
      >
        <form action={action} className="space-y-4">
