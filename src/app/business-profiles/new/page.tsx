  ...
  return (
    <>
      <PageHeader
        ...
        description="A profile is how other people on Buildora find you — as a partner, a client, a supplier or a buyer."
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            ...
            <Notice tone="gold" title="Looking for investors?">
              ...
              is a regulated activity in most jurisdictions, and Buildora will not
