...
export default async function SearchPage({
  ...
  return (
    <>
      <PageHeader
        eyebrow="Search"
        title={raw ? `Results for “${raw}”` : "Search Buildora"}
        description="Describe what you want in plain language. Buildora turns it into filters — marketplace, category, price range and more — and you can adjust them afterwards."
      />
