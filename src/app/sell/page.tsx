...
export const metadata = {
  ...
  description:
    "List your business, patent, technology, digital asset or service on Buildora. Free to list — commission only on a completed transaction.",
};
