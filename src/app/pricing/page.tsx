...
export const metadata = {
  title: "Pricing & Fees",
  description:
    "Buildora charges a commission on successful transactions. Listing is free. Featured placement, boosts, verification and subscriptions are optional.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Listing on Buildora is free. The platform earns when you do — a commission on completed transactions — plus optional visibility and tooling."
      >
      ...
      <div className="shell py-12">
        ...
        <div className="mt-6">
          <Notice tone="gold" title="Payments in this MVP">
            Buildora records transactions and shows the commission split, but does
