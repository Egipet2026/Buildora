      ...
      sections={[
        {
          ...
          paragraphs: [
            "A Verified badge means BizHub checked specific facts a member gave us, against evidence they supplied and against public records, so far as we can lawfully check them.",
