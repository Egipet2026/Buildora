      ...
      sections={[
        ...
        },
        {
          ...
          list: [
            ...
            "Do not imply that Bizora has assessed the validity, enforceability, scope or value of any intellectual property.",
          ],
        },
        {
          heading: "3. No regulated offerings",
          paragraphs: [
            "Bizora does not host offers of securities, shares, bonds, fund interests, tokens or other regulated financial products, and does not host solicitations of investment.",
        ...
        },
        {
          ...
          list: [
            "Negotiate through Bizora so both sides keep a record.",
        ...
        },
        {
          ...
          paragraphs: [
            "Every listing is reviewed before publication. Review looks for obvious problems — it is not an audit, and approval does not mean Bizora endorses or has confirmed a listing.",
