      ...
      sections={[
        ...
        },
        {
          ...
          list: [
            ...
            "Do not imply that Buildora has assessed the validity, enforceability, scope or value of any intellectual property.",
          ],
        },
        {
          heading: "3. No regulated offerings",
          paragraphs: [
            "Buildora does not host offers of securities, shares, bonds, fund interests, tokens or other regulated financial products, and does not host solicitations of investment.",
        ...
        },
        {
          ...
          list: [
            "Negotiate through Buildora so both sides keep a record.",
        ...
        },
        {
          ...
          paragraphs: [
            "Every listing is reviewed before publication. Review looks for obvious problems — it is not an audit, and approval does not mean Buildora endorses or has confirmed a listing.",
