      ...
      sections={[
        {
          ...
          paragraphs: [
            "This describes what personal data BizHub collects, why, and what members can do about it. It is written to reflect how the platform actually behaves, and must be reviewed against the data-protection law of each market before the platform operates commercially.",
          ],
        },
        {
